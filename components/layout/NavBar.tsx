 ...
 * holding About and Settings (and every other page on small screens).
 */
export function NavBar() {
  ...
  const linkClass = (href: string) =>
    `rounded-full px-3.5 py-2 text-sm font-semibold transition-colors duration-150 ${
      pathname === href ? "bg-accent-soft text-accent" : "text-muted hover:bg-highlight hover:text-foreground"
    }`;
